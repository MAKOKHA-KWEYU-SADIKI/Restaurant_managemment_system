...
export type TSaddress=typeof tableAddress.$inferInsert;
export type TIaddress=typeof tableAddress.$inferSelect;
export type TScomment=typeof tableComment.$inferInsert;
